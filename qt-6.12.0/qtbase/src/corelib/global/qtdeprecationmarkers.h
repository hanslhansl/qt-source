...
#  undef QT_DEPRECATED_MACRO
#  define QT_DEPRECATED_MACRO(macro, text) Q_DECL_DEPRECATED_MACRO(macro, text)
#else
#  undef QT_DEPRECATED
...
#  undef QT_DEPRECATED_MACRO
#  define QT_DEPRECATED_MACRO(macro, text)
...
/* QT_DEPRECATED_MACRO is \since 6.12, so there are no versioned ones before that */
...
# define QT_DEPRECATED_MACRO_6_12(macro, text) QT_DEPRECATED_MACRO(macro, text)
#else
# define QT_DEPRECATED_VERSION_X_6_12(text)
# define QT_DEPRECATED_VERSION_6_12
# define QT_DEPRECATED_MACRO_6_12(macro, text)
#endif
...
# define QT_DEPRECATED_MACRO_6_13(macro, text) QT_DEPRECATED_MACRO(macro, text)
#else
# define QT_DEPRECATED_VERSION_X_6_13(text)
# define QT_DEPRECATED_VERSION_6_13
# define QT_DEPRECATED_MACRO_6_13(macro, text)
#endif
...
# define QT_DEPRECATED_MACRO_6_14(macro, text) QT_DEPRECATED_MACRO(macro, text)
#else
# define QT_DEPRECATED_VERSION_X_6_14(text)
# define QT_DEPRECATED_VERSION_6_14
# define QT_DEPRECATED_MACRO_6_14(macro, text)
#endif
...
# define QT_DEPRECATED_MACRO_6_15(macro, text) QT_DEPRECATED_MACRO(macro, text)
#else
# define QT_DEPRECATED_VERSION_X_6_15(text)
# define QT_DEPRECATED_VERSION_6_15
# define QT_DEPRECATED_MACRO_6_15(macro, text)
#endif
...
# define QT_DEPRECATED_MACRO_6_16(macro, text) QT_DEPRECATED_MACRO(macro, text)
#else
# define QT_DEPRECATED_VERSION_X_6_16(text)
# define QT_DEPRECATED_VERSION_6_16
# define QT_DEPRECATED_MACRO_6_16(macro, text)
#endif
