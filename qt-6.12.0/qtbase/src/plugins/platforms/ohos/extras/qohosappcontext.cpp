...
/*!
    \class QtHarmonyExtras::AppContext
...
/*!
    \fn static AppContext *QtHarmonyExtras::AppContext::instance()
...
/*!
    \fn static bool QtHarmonyExtras::AppContext::isNoUiChildMode()
...
/*!
    \fn static void QtHarmonyExtras::AppContext::startNoUiChildProcess(const QString &libraryName, const QStringList &args)
    ...
    \code
    QtHarmonyExtras::AppContext::startNoUiChildProcess(
        "libapp.so",
        QStringList{
            "first arg",
            "second arg",
...
/*!
    \fn static std::shared_ptr<QtHarmonyExtras::WantInfo> QtHarmonyExtras::AppContext::appLaunchWantInfo()
...
/*!
    \fn static void QtHarmonyExtras::AppContext::restartApp(const std::optional<QtHarmonyExtras::Want> &want)
    ...
    \code
    QtHarmonyExtras::Want requestWant = QtHarmonyExtras::AppContext::getAppLaunchWant();
    ...
    QtHarmonyExtras::AppContext::restartApp(requestWant);
    \endcode
*/
...
/*!
    \fn bool QtHarmonyExtras::AppContext::hasSerialPortAccessRight(const QString &portName) const
...
/*!
    \fn void QtHarmonyExtras::AppContext::requestSerialPortAccessRightIfNeeded(const QString &portName, QObject *context, std::function<void(std::shared_ptr<QObject>)> callback)
...
/*!
    \fn std::shared_ptr<BundleInfo> QtHarmonyExtras::AppContext::bundleInfo() const
