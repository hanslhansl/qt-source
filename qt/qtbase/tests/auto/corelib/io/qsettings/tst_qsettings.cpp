...
{
#if defined(QT_BUILD_INTERNAL) && defined(Q_OS_UNIX) && !defined(Q_OS_DARWIN) && !defined(Q_OS_ANDROID) && !defined(Q_OS_HARMONY) && !defined(Q_OS_WASM) && !defined(QT_NO_STANDARDPATHS)
